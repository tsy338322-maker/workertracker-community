(function initWorkspaceConfig(root) {
    const SYSTEM_MODULE_REGISTRY = [
        ...
        { module_key: 'staffAccess', module_name: 'User Access', icon: 'KeyRound', sidebar_visible: true, sort_order: 190, enabled: true, system_module: true, category: 'system', access: 'management', fields: [] },
    ...
    const WORKSPACE_NAVIGATION = [
        ...
        { id: 'staffAccess', label: 'User Access' },
